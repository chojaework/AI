...
class MyAgent(Agent):
    ...
    def getAction(self, state):
        ...
        problem = AnyFoodSearchProblem(state, AgentIndex)
        food = state.getFood()
        AgentIndexDiv4 = AgentIndex % 4

        #[width, height]
        AreaDiv4 = [[(0, food.width//2), (0, food.height//2)],
                    [(0, food.width//2), (food.height//2 + 1, food.height)],
                    [(food.width//2 + 1, food.width), (0, food.height//2)],
                    [(food.width//2 + 1, food.width), (food.height//2 + 1, food.height)]]
        width, height = AreaDiv4[AgentIndexDiv4][0], AreaDiv4[AgentIndexDiv4][1]
        
        def FoodInArea(food, width, height):
        ...
        if FoodInArea(food, width, height):
